                ...
                <div class="row row-cols-1 row-cols-lg-2 row-cols-xl-3">
                    <div class="col mx-auto">
                        <div class="mb-4 text-center">
                            <img src="<?php echo BASE_URL; ?>assets/images/logopng.png" width="180" alt="LOGO" />
                        </div>
                        <div class="card">
                            <div class="card-body">
                                <div class="border p-4 rounded">
                                    <div class="text-center">
                                        <h3 class="">Iniciar sesión como administrador</h3>
                                    </div>
                                    <div class="login-separater text-center mb-4"> <span>Ingresa tu Correo y Contraseña</span>
                                        <hr/>
                                    </div>
                                    <div class="form-body">
                                        <form class="row g-3" id="formulario">
                                            ...
                                            <div class="col-12">
                                                <div class="d-grid">
                                                    <button type="submit" class="btn btn-success"><i class="bx bxs-lock-open"></i>Ingresar</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
