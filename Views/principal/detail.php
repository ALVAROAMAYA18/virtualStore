                        ...
                        <div class="p-2 pb-3">
                            <div class="product-wap card rounded-0">
                                <div class="card rounded-0">
                                    <img class="card-img rounded-0" src="<?php echo BASE_URL . 'assets/images/productos/'. $data['producto']['id'] . '/' . $data['imagenes'][$i]; ?>" width="100" height="200">
                                </div>
                            </div>
                        </div>
                    <?php } ?>
        ...
        <div id="carousel-related-product">
            <?php foreach ($data['relacionados'] as $producto) { ?>
                <div class="p-2 pb-3">
                    <div class="product-wap card rounded-0">
                        <div class="card rounded-0">
                            <img class="card-img rounded-0" src="<?php echo BASE_URL . $producto['imagen'];?>" width="130" height="250">
