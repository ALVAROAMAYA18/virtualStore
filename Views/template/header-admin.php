...
<head>
    ...
    <!--favicon-->
    <link rel="icon" href="<?php echo BASE_URL; ?>assets/favicon/favicon.ico" type="image/png" />
    ...
    <div class="wrapper">
        ...
        <div class="sidebar-wrapper" data-simplebar="true">
            <div class="sidebar-header">
                <div>
                    <img src="<?php echo BASE_URL; ?>assets/favicon/favicon-32x32.png" class="logo-icon" alt="logo icon">
                </div>
                <div>
                    <h4 class="text-success"><?php echo TITLE; ?></h4>
                </div>
            ...
            <ul class="metismenu" id="menu">
                <li>
                    <a href="<?php echo BASE_URL . 'admin/home'; ?>">
                        ...
                        <div class="menu-title">Estadísitcas</div>
                    </a>
                </li>
                <li>
                ...
                <nav class="navbar navbar-expand">
                    ...
                    <div class="user-box dropdown">
                        <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <img src="<?php echo BASE_URL; ?>assets/favicon/favicon-32x32.png" class="user-img" alt="user avatar">
